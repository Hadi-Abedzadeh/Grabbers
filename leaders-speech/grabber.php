...
*  _                    _                                       _
* | | Hadi Abedzadeh   | |                                     | |
* | |     ___  __ _  __| | ___ _ __ ___  __      _____  _ __ __| |___
* | |    / _ \/ _` |/ _` |/ _ \ '__/ __| \ \ /\ / / _ \| '__/ _` / __|
* | |___|  __/ (_| | (_| |  __/ |  \__ \  \ V  V / (_) | | | (_| \__ \
* |______\___|\__,_|\__,_|\___|_|  |___/   \_/\_/ \___/|_|  \__,_|___/
*
*
*/
if(isset($argv[1], $argv[2], $argv[3])){
  ...
  echo "\n
  _                    _                                       _
 | | Hadi Abedzadeh   | | Time.ir & P30download.com           | |
 | |     ___  __ _  __| | ___ _ __ ___  __      _____  _ __ __| |___
 | |    / _ \/ _` |/ _` |/ _ \ '__/ __| \ \ /\ / / _ \| '__/ _` / __|
 | |___|  __/ (_| | (_| |  __/ |  \__ \  \ V  V / (_) | | | (_| \__ \
 |______\___|\__,_|\__,_|\___|_|  |___/   \_/\_/ \___/|_|  \__,_|___/
...
// Paperg: Add the colon to the attrbute, so that it properly finds <tag attr:ibute="something" > like google does.
  ...
  for ($x = 1; $x <= $countTime; $x++) {
    $load = file_get_html('http://www.time.ir/');
    foreach ($load->find('span[class=h4 quoteText]') as $load) {
      file_put_contents($argv[3], '<div class="text">' . $load->plaintext . '</div>' . "\n", FILE_APPEND);
    }
  }
  for ($x = 1; $x <= $countP30; $x++) {

    $load = file_get_html('http://p30download.com/contact.php');
    foreach ($load->find('div[class=header-slogan]') as $load) {
      file_put_contents($argv[3], '<div class="text">' . $load->plaintext . '</div>' . "\n", FILE_APPEND);
    }
  }
  ...
  echo "\n\tGrbber.php Time.ir p30download.com file.html";
  echo "\n\t\tExample : Grbber.php 10 10 file.html";
}
?>
